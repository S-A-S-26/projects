...
SECRET_KEY = 'django-insecure-&-wj=0%d66003ski9_(%ink@kanfhk)$dmmp#o@0e*#6!v#av&'
...
# added to allow all websites for cors
...
# added this for storing files 
MEDIA_URL='media/'
MEDIA_ROOT= os.path.join(BASE_DIR,'media/')


#added
# STATICFILES_DIR=[os.path.join(BASE_DIR,'socialapp/vite')]