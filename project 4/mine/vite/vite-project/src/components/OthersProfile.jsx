...
export default function OthersProfile({ setLogin,profileData,otherUserProfile,getProfile,fetchPosts,posts,getCsrf,csrfValue,setEditPost,setEditPost_Post,setimgWin,previewImg,setPreviewImg,showReg,showLogin,postHeading,handleFollow,refresh,getOtherProfile}) {
  ...
  return (
    ...
    <Posts {...{ setLogin,getOtherProfile,handleFollow,refresh,getProfile,fetchPosts,posts,getCsrf,csrfValue,setEditPost,setEditPost_Post,setimgWin,previewImg,setPreviewImg,showReg,showLogin,postHeading,otherUserProfile,profileData,otherUserProfile}}/>
    </>
  )
}
